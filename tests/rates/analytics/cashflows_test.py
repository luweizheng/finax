...
class CashflowsTest(jtu.JaxTestCase):
  ...
  def test_pv_from_yields_no_group(self, dtype):
    ...
    actual_pv = finax.rates.analytics.cashflows.pv_from_yields(
  ...
  def test_pv_from_yields_grouped(self, dtype):
    ...
    actual_pvs = finax.rates.analytics.cashflows.pv_from_yields(
  ...
  def test_yields_from_pvs_no_group(self, dtype):
    ...
    actual_yield_rate = finax.rates.analytics.cashflows.yields_from_pv(
  ...
  def test_yields_from_pv_grouped(self, dtype):
    ...
    actual_yield_rates = finax.rates.analytics.cashflows.yields_from_pv(
  ...
  def test_yield_saturated_pv(self, dtype):
    ...
    expected_yields = [0., 0.]
    actual_yields = finax.rates.analytics.cashflows.yields_from_pv(
            cashflows, times, pvs, groups=groups, dtype=dtype)
  ...
  def test_discount_factors(self, dtype):
    ...
    actual_prices = finax.rates.analytics.cashflows.present_value(
            cashflows,
            discount_factors,
            dtype=dtype)
