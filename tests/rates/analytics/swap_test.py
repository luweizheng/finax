...
class SwapTest(jtu.JaxTestCase):
  ...
  def test_equity_leg_cashflows(
    ...
    dtype = np.float64
    actual_pv  = finax.rates.analytics.swap.equity_leg_cashflows(
  ...
  def test_rate_leg_cashflows(
    ...
    dtype = np.float64
    actual_pv = .rates.analytics.swap.rate_leg_cashflows(
  ...
  def test_swap_price(
    ...
    dtype = np.float64
    actual_pv = finax.rates.analytics.swap.swap_price(
  ...
  def test_ir_swap_price(
    ...
    dtype = np.float64
    actual_pv = finax.rates.analytics.swap.ir_swap_price(
  ...
  def test_ir_swap_par_rate_and_annuity(self, floating_leg_start_times,
    ...
    dtype = np.float64
    actual_parrate, actual_annuity = finax.rates.analytics.swap.ir_swap_par_rate_and_annuity(
  ...
  def test_equity_swap_price(
    ...
    dtype = np.float64
    actual_pv = finax.rates.analytics.swap.equity_swap_price(
